...
import 'package:flutter_app2/commons/fullPhoto.dart';
import 'package:flutter_app2/commons/utils.dart';
import 'package:flutter_app2/controllers/FBCloudStore.dart';
import 'package:flutter_app2/subViews/commentItem.dart';
...
class _ContentDetail extends State<ContentDetail> {
  ...
  Widget _buildTextComposer() {
    return new IconTheme(
      data: new IconThemeData(color: Color(0xff40e0d0)),
      child: new Container(
